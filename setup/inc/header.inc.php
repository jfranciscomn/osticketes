...
<head>
    ...
    <link rel="stylesheet" href="css/wizard.css?4b0877c"/>
    <script type="text/javascript" src="../js/jquery-1.8.3.min.js?4b0877c"></script>
    <script type="text/javascript" src="js/tips.js?4b0877c"></script>
    <script type="text/javascript" src="js/setup.js?4b0877c"></script>
</head>
<body>
    <div id="wizard">
        <div id="header">
