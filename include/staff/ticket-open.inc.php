...
<form action="tickets.php?a=open" method="post" id="save"  enctype="multipart/form-data">
 ...
 <table class="form_table fixed" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        <tr>
            <th colspan="2">
                <em><strong>Informacion del Usuario</strong>: </em>
            </th>
        </tr>
        <?php
        if ($user) { ?>
        ...
        <?php
            ...
            ?>
        <tr>
            <td width="160" class="required"> Correo Electronico: </td>
            <td>
        ...
        <tr>
            <td width="160" class="required"> Nombre Completo: </td>
            <td>
                <span style="display:inline-block;">
        ...
        <tr>
            <td width="160">Noticias:</td>
            <td>
            <input type="checkbox" name="alertuser" <?php echo (!$errors || $info['alertuser'])? 'checked="checked"': ''; ?>>Enviar noticias al Usuario.
            </td>
        </tr>
        <?php
        } ?>
    ...
    <tbody>
        <tr>
            <th colspan="2">
                <em><strong>Informacion y opciones del ticket </strong>:</em>
            </th>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <option value="" selected >&mdash; Seleccionar Topico &mdash;</option>
<?php                   }
        ...
        <tr>
            ...
            <td>
                <select name="deptId">
                    <option value="" selected >&mdash; Seleccionar departamento &mdash;</option>
                    <?php
         ...
         <tr>
            ...
            <td>
                ...
                <em>La hora esta basada en la zona (GMT <?php echo $thisstaff->getTZoffset(); ?>)</em>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <select id="assignId" name="assignId">
                    <option value="0" selected="selected">&mdash; Seleccionar un miembro o equipo &mdash;</option>
                    <?php
                    if(($users=Staff::getAvailableStaffMembers())) {
                        echo '<OPTGROUP label="Miembros ('.count($users).')">';
        ...
        <tr>
            <th colspan="2">
                <em><strong>Respuesta</strong>: Respuesta del asunto.</em>
            </th>
        </tr>
        <tr>
            <td colspan=2>
            ...
            if($thisstaff->canCloseTickets()) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <b>Cerrar al responder</b>&nbsp;<em>(Solo si el asunto quedo solucionado)</em>
                    </td>
                </tr>
            <?php
            } ?>
             <tr>
                ...
                <td>
                    ...
                    <label><input type="radio" name="signature" value="dept"
                        <?php echo ($info['signature']=='dept')?'checked="checked"':''; ?>> Firma del departamento</label>
                </td>
             </tr>
            </table>
            </td>
        ...
        <tr>
            <td colspan=2>
                <textarea class="richtext ifhtml draft draft-delete"
                    placeholder="Nota interna Opcional (recomendado si existe asignacion)"
