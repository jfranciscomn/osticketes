...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/osticket.css?4b0877c" media="screen"/>
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/theme.css?4b0877c" media="screen"/>
    <link rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/print.css?4b0877c" media="print"/>
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>scp/css/typeahead.css?4b0877c"
         media="screen" />
    <link type="text/css" href="<?php echo ROOT_PATH; ?>css/ui-lightness/jquery-ui-1.10.3.custom.min.css?4b0877c"
        rel="stylesheet" media="screen" />
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/thread.css?4b0877c" media="screen"/>
    ...
    <script src="<?php echo ROOT_PATH; ?>js/jquery.multifile.js?4b0877c"></script>
    <script src="<?php echo ROOT_PATH; ?>js/osticket.js?4b0877c"></script>
    <script src="<?php echo ROOT_PATH; ?>scp/js/bootstrap-typeahead.js?4b0877c"></script>
        ...
        <div id="header">
            ...
            <p>
             ...
             if($thisclient && is_object($thisclient) && $thisclient->isValid()) {
                 ...
                 ?>
                <a href="<?php echo ROOT_PATH; ?>profile.php">Perfil</a> |
                <?php
             ...
             <?php
                 ...
                 Invitado | <a href="<?php echo ROOT_PATH; ?>login.php">Accesar</a>
              <?php
             } ?>
            </p>
        </div>
